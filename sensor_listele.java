 ...
 * @author Burcu
 */
public class sensor_listele extends javax.swing.JFrame {
    ...
    public void veriListele() throws SQLException{
        ...
        for(int i=0;i<ls.size();i++){
            birlestir += "Sicaklik= " + ls.get(i).getSicaklik() + " " + "Gaz Miktari= " +ls.get(i).getGaz() + "\n";
        }
        jTextArea1.setText(birlestir);
   
        
    }
    public sensor_listele() throws SQLException {
        initComponents();
        veriListele();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sensor_listele.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
